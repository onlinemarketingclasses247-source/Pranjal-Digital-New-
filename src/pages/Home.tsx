...
const comparisonData = [
  { aspect: 'Years of Hands-On Experience', agency: 'Average 2-4 years (high turnover, junior talent)', me: '12+ years — I have done it all, seen it all, fixed it all', major: true, agencyIcon: '📉', meIcon: '🏆', detail: 'Agencies often assign fresh graduates to your account. I bring over a decade of battle-tested experience.' },
  { aspect: 'Who Actually Works On Your Account', agency: 'Rotating junior account managers (changes every 6 months)', me: 'Direct access to me — the expert who built this business', major: true, agencyIcon: '🔄', meIcon: '👨‍💻', detail: 'No handovers. No "let me check with my manager". You get decisions instantly.' },
  { aspect: 'Response Time & Communication', agency: '24-72 hours (through multiple layers of approval)', me: '2-4 hours — WhatsApp, Call, or Email. Direct line to me.', major: true, agencyIcon: '🐢', meIcon: '⚡', detail: 'When a campaign needs immediate attention, I respond. Not a ticket system.' },
  { aspect: 'Strategy Development', agency: 'Template-based approach — one size fits all', me: '100% custom strategy built specifically for YOUR business', major: true, agencyIcon: '📋', meIcon: '🎯', detail: 'I study your business, competitors, customers, and market before writing a single word of strategy.' },
  { aspect: 'Contract & Commitment', agency: '6-12 month lock-in contracts + auto-renewal', me: 'Month-to-month. Cancel anytime. No questions asked.', major: false, agencyIcon: '🔒', meIcon: '🔓', detail: 'I earn your business every single month. If you are not happy, you walk away.' },
  { aspect: 'Reporting & Metrics', agency: 'Vanity metrics — impressions, clicks, "brand awareness"', me: 'Revenue-tied KPIs — ROAS, CAC, LTV, pipeline value', major: true, agencyIcon: '📊', meIcon: '💰', detail: 'I only report on metrics that impact your bottom line. No fluff. No BS.' },
  { aspect: 'Team Access & Resources', agency: 'Limited to 1 account manager (the rest are "internal")', me: 'Full team of 25+ specialists — designers, writers, developers, analysts', major: false, agencyIcon: '👤', meIcon: '👥', detail: 'You get a full agency\'s firepower. But you pay freelancer rates. And you talk to me directly.' },
  { aspect: 'Pricing Model & Transparency', agency: 'High retainers + hidden fees + markup on ad spend', me: 'Use the calculator. Fixed project. Hourly. Whatever works for you.', major: true, agencyIcon: '💸', meIcon: '💎', detail: 'No hidden fees. No markup on your ad spend. You pay exactly what we agree.' },
  { aspect: 'Industry Experience Depth', agency: 'Generalist — spread thin across 50+ industries', me: 'Deep expertise in 25+ industries with proven playbooks', major: false, agencyIcon: '🌐', meIcon: '🎓', detail: 'I bring best practices from every industry I have worked with. Your competitors might be from a different sector.' },
  { aspect: 'AI & Technology Integration', agency: 'Basic or outsourced (they charge you extra for "AI services")', me: 'Advanced AI — PMax, Advantage+, GPT optimization, AI funnels', major: true, agencyIcon: '🤖', meIcon: '🧠', detail: 'I use AI to automate, optimize, and scale. You get cutting-edge tech without the markup.' },
  { aspect: 'Risk & Accountability', agency: 'They get paid even if you get zero results', me: 'My reputation is on the line. I only succeed when you succeed.', major: true, agencyIcon: '⚠️', meIcon: '✅', detail: 'I am personally invested in your success. My business grows when your business grows.' },
];
...
export default function Home() {
  ...
  return (
    <div className="bg-[#080c14] overflow-hidden">
      ...
      <section className="py-20 bg-gradient-to-b from-[#040608] to-[#080c14]">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          <div className="grid lg:grid-cols-2 gap-6 items-center">
            <div className="bg-[#0a0f1c] border border-white/10 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-[#c9a84c] font-semibold mb-3 text-xs uppercase tracking-wider">Global Clients</h3>
                ...
                <div className="grid grid-cols-3 text-center">
                  <div><p className="text-[#c9a84c] font-bold text-xl">400+</p><p className="text-white/40 text-xs">Clients</p></div>
                  <div><p className="text-[#c9a84c] font-bold text-xl">20+</p><p className="text-white/40 text-xs">Countries</p></div>
                  <div><p className="text-[#c9a84c] font-bold text-xl">12+</p><p className="text-white/40 text-xs">Years</p></div>
                </div>
                <div className="mt-4 text-white/40 text-xs text-center">Proven Global Experience</div>
              </div>
            </div>
            <WorldMap />
          </div>
      ...
      {/* ========== VIDEO SECTION ========== */}
      <section className="py-20 bg-gradient-to-b from-[#080c14] to-[#0a0f1c]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why I Started Pranjal Digital?</h2>
              ...
              <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                <div className="flex items-center gap-2 bg-white/5 rounded-full px-4 py-2"><CheckCircle2 size={16} className="text-[#c9a84c]" /><span className="text-white/70 text-sm">12+ Years Experience</span></div>
                <div className="flex items-center gap-2 bg-white/5 rounded-full px-4 py-2"><CheckCircle2 size={16} className="text-[#c9a84c]" /><span className="text-white/70 text-sm">400+ Happy Clients</span></div>
                <div className="flex items-center gap-2 bg-white/5 rounded-full px-4 py-2"><CheckCircle2 size={16} className="text-[#c9a84c]" /><span className="text-white/70 text-sm">20+ Countries</span></div>
              </div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
      ...
      <section className="py-20 bg-gradient-to-b from-[#080c14] to-[#040608]">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {service.features.map((feature, idx) => (
                    <span key={idx} className="text-[10px] bg-white/5 border border-white/10 rounded-full px-2 py-1 text-white/50">{feature}</span>
                  ))}
                </div>
                <p className="text-white/40 text-xs leading-relaxed border-t border-white/10 pt-3 mt-2">{service.detailedDesc}</p>
              </motion.div>
            ))}
          </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 gap-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                {industriesData.map((industry, i) => (
                  ...
                  >
                    ...
                    {selectedIndustry?.name === industry.name && <CheckCircle2 size={14} className="text-[#c9a84c]" />}
                  </motion.button>
                ))}
              </div>
            </div>
                ...
                <>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white/5 rounded-xl p-4">
                      <h4 className="text-[#c9a84c] font-semibold mb-2 flex items-center gap-2"><CheckCircle2 size={16} /> What I Have Done</h4>
                      <p className="text-white/70 leading-relaxed">{selectedIndustry.whatIDid}</p>
                    </div>
                    <div className="bg-white/5 rounded-xl p-4">
                      <h4 className="text-[#c9a84c] font-semibold mb-2 flex items-center gap-2"><Target size={16} /> What I Can Do For You</h4>
                      <p className="text-white/70 leading-relaxed">{selectedIndustry.whatICanDo}</p>
                    </div>
                    <div>
                      <h4 className="text-[#c9a84c] font-semibold mb-3 flex items-center gap-2"><TrendingIcon size={16} /> Key Results I Have Delivered</h4>
      ...
      <section className="py-20 bg-[#080c14] relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-white/60">Clear differences. No fluff. Just what impacts your growth.</p>
          </div>
          <div className="rounded-2xl border border-white/10 overflow-hidden backdrop-blur-xl">
            <div className="grid grid-cols-3 bg-[#0a0f1c] text-sm font-semibold">
              ...
              <div className="p-4 text-center text-white/50 border-l border-white/10">Big Agency</div>
              <div className="p-4 text-center border-l border-[#c9a84c]/30 bg-[#c9a84c]/5 text-[#c9a84c]">Pranjal Digital</div>
            </div>
            {[
              { title: "Experience", agency: "2–4 yrs avg team", me: "12+ yrs hands-on" },
              { title: "Who Works On Account", agency: "Junior managers", me: "Direct expert" },
              { title: "Communication", agency: "24–72 hrs delay", me: "Same-day response" },
              { title: "Strategy", agency: "Template-based", me: "Custom-built" },
              { title: "Execution Speed", agency: "Slow approvals", me: "Fast & agile" },
              { title: "Pricing", agency: "High retainers", me: "Flexible & transparent" },
              { title: "Metrics", agency: "Clicks & impressions", me: "Revenue & ROI" },
              { title: "Accountability", agency: "Low ownership", me: "Direct responsibility" },
            ].map((row, i) => (
              <div key={i} className="grid grid-cols-3 text-sm border-t border-white/10 hover:bg-white/5 transition">
                <div className="p-4 text-white font-medium">{row.title}</div>
                <div className="p-4 text-center text-white/50 border-l border-white/10 flex items-center justify-center gap-2"><span className="text-red-400">✕</span>{row.agency}</div>
                <div className="p-4 text-center border-l border-[#c9a84c]/20 bg-gradient-to-r from-[#c9a84c]/5 to-transparent flex items-center justify-center gap-2"><span className="text-[#c9a84c]">✓</span><span className="text-white/80 font-medium">{row.me}</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#040608] to-[#080c14]">
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-white/50 text-lg">Everything you wanted to know. In simple English. No BS.</p>
          </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-5">
              ...
              <span className="bg-gradient-to-r from-[#c9a84c] to-[#f0d282] bg-clip-text text-transparent">Digital Marketing ROI?</span>
            </h2>
